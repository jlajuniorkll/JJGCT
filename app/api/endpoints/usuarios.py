...
def read_usuarios(skip: int = 0, limit: int = 100, incluir_inativos: bool = False, db: Session = Depends(get_db)):
    usuarios = crud.get_usuarios(db, skip=skip, limit=limit, apenas_ativos=not incluir_inativos)
    return usuarios
